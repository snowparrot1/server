...
static inline int msg_ts(unsigned int thread_num, const char *fmt, ...) ATTRIBUTE_FORMAT(printf, 2, 3);
static inline int msg_ts_va_list(uint thread_num, const char *fmt, va_list args)
{
  int result;
  time_t t = time(NULL);
  char date[100];
...
static inline int msg_ts(unsigned int thread_num, const char *fmt, ...)
{
  int result;
  va_list args;
  va_start(args, fmt);
  result = msg_ts_va_list(thread_num, fmt, args);
  va_end(args);
  return result;
}
...
static inline int msg_ts(const char *fmt, ...) 
{
  ...
  va_list args;
  va_start(args, fmt);
  result = msg_ts_va_list(0, fmt, args);
  va_end(args);
  return result;
}
